...
public class Institution implements Serializable {
	...
	private static final Long serialVersionUID = 755224195781828341L;
	...
	public String toString() {
		return "Institution [institutionId=" + institutionId + ", createdBy=" + createdBy + ", createdDate="
				...
				+ insMediumOfEducation + ", insParentId=" + insParentId + ", insPhone=" + insPhone + ", insPinCode="
				+ insPinCode + ", insState=" + insState + ", insStatus=" + insStatus + ", insType=" + insType
				+ ", insWebsiteUrl=" + insWebsiteUrl + ", institutionName=" + institutionName
				+ ", institutionRegistraionCode=" + institutionRegistraionCode + ", updatedBy=" + updatedBy
